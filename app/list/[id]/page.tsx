...
const page = async ({ params }: { params: paramsType }) => {
  ...
  for(let i = 1; i <= len; i++){
    const classVal = Number(params.id) === i ? "h-10 w-10 bg-blue-800 hover:bg-blue-600 font-semibold text-white text-sm flex items-center justify-center"
